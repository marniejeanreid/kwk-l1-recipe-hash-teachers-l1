...
# perfect_10_ingredients = {:almond_flour => '2 cups',
# :gluten_free_whole_oats => '1 cup', :kosher_salt => '1/2 tea spoon', :baking_powder => '1/2 tea spoon', :baking_soda => '1/4 tea spoon', :xanthan_Gum => '1/2 tea spoon', :slivered_almonds => '1/4 cup', :mini_dark_chocolate_chips => '3/4 cup', :olive_oil => '1/2 cup', :agave => '1/4 cup'}
...
def amount_of_chocolate_chips(perfect_10_ingredients)
  return perfect_10_ingredients[:mini_dark_chocolate_chips]
end
...
def ingredients_and_amounts(perfect_10_ingredients)
  perfect_10_ingredients.each do |ingredient, amount|
...
def ingredients(perfect_10_ingredients)
  perfect_10_ingredients.each_key do |ingredient|
    puts "#{ingredient}"
  end
end

#5: Now use `puts` to print out just the amounts without the ingredients. You'll want to use the `each_value` method.
def amounts(perfect_10_ingredients)
  perfect_10_ingredients.each_value do |amount|
    puts "#{amount}"
  end
end

#6: Return the number of ingredients in the `perfect_10_recipe` hash.
def number_ingredients(perfect_10_ingredients)
  # count = 0
  # perfect_10_ingredients.each_key do |ingredient|
  #   count += 1
  #   return count
  # end
  perfect_10_ingredients.length
end
